# happones/laravel-zip

[![Downloads](https://img.shields.io/packagist/dt/happones/laravel-zip.svg?style=flat-square)](https://packagist.org/packages/happones/laravel-zip)
[![GitHub license](https://img.shields.io/badge/License-MIT-informational.svg)](https://github.com/happones/laravel-zip/blob/master/LICENSE)
...
[![GitHub tag](https://img.shields.io/github/tag/Happones/laravel-zip.svg?style=flat&logo=laravel&color=informational)](https://github.com/happones/laravel-zip/tags)
...
Require this package in your composer.json and update composer. This will download the package.
    ...
    composer require happones/laravel-zip

After updating composer, add the ServiceProvider to the providers array in config/app.php

    Happones\Zip\ZipServiceProvider::class,

You can optionally use the facade for shorter code. Add this to your facades:

    'Zip' => Happones\Zip\Facades\Zip::class,


## Zip usage

use `Happones\Zip\Zip` class only use `Zip` is made to handle a zip file.
...
The `\Happones\Zip\ZipManager` can handle multiple `Happones\Zip\Zip` objects.

- include the Zip and ZipManager class at top:
```php
use Happones\Zip\ZipManager;
use Zip;
```
